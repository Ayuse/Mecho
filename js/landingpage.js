...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    amount: 1000 * 100,
    ref: 'mecho' + Math.floor(Math.random() * 1000000000 + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
